...
Mesh::Mesh::Mesh(Material mat, const char* path, Transform* _transform) : Renderer()
{
	Renderer::mat = mat;
...
Mesh::Mesh::Mesh(Material mat, const char* path,  char* texture_Path, Transform* _transform) : Renderer()
{
...
void Mesh::Mesh::Render()
{
	glUseProgram(m_program);

	glm::mat4 translation = glm::translate(glm::mat4(), transform->position);
	glm::mat4 scale = glm::scale(glm::mat4(), transform->scale);
	glm::mat4 rotZ = glm::rotate(glm::mat4(), transform->rotation.z, glm::vec3(0,0,1));
	glm::mat4 rotY = glm::rotate(rotZ, transform->rotation.y, glm::vec3(0,1,0));
	glm::mat4 rotX = glm::rotate(rotY, transform->rotation.x, glm::vec3(1,0,0));

	m_objMat = translation * rotX * scale;
